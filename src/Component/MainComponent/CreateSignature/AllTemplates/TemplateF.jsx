					...
					<div class="flex px-4 bg-white">
						<div class="w-full">
							...
							<div class="">
								...
								<h1 style={{ fontSize: `${counter}px`, color: colors,fontFamily:FontsizeChange  }}>{name}</h1>

								</h4>
								<span class="font-bold text-blue-700 text-sm float-left mt-1 pb-2">
								
									<h1 style={{ fontSize: `${counter}px` , color: colors,fontFamily:FontsizeChange }}>
						...
						<div class="float-left ml-7">
							<a href={facebookLink}>
								<img
									...
									style={{ border: "none",width: `${spacings}px`,height:`${spacings}` }}
								/>
							</a>
							<a href={twitterLinkA}>
								<img
